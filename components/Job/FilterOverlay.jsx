          ...
          <View style={styles.container}>
            <View style={styles.header}>
              ...
              <View style={styles.iconContainer}>
                {selectedJobType ||
                selectedJobLevel.length ||
                selectedSalaryType.length ||
                selectedExpType.length ||
